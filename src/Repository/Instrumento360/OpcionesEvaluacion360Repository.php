...
class OpcionesEvaluacion360Repository extends ServiceEntityRepository
{
    ...
    public function findAllPage($data){
        ...
        foreach($paginator as $clave=>$valor){
            $opcionesDto =new OpcionesEvaluacion360OutPutDto();
    ...
    public function post($data,$validator,$helper): JsonResponse  {
        ...
        $entity=$helper->setParametersToEntity(new OpcionesEvaluacion360(),$data);
    ...
    {
        $entityManager = $this->getEntityManager();
        $entity =$entityManager->getRepository(OpcionesEvaluacion360::class)->find($id);
        if (!$entity) {
            return new JsonResponse(['msg'=>'No existen Registros con el id: '.$id],404);  
        }
   ...
   {
       $entityManager = $this->getEntityManager();
       $entityOpciones =$entityManager->getRepository(OpcionesEvaluacion360::class)->find($id);
       if (!$entityOpciones) {
           return new JsonResponse(['msg'=>'No existen Registros con el id: '.$id],404);  
       }
