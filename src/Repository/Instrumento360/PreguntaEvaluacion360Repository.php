...
class PreguntaEvaluacionRepository extends ServiceEntityRepository
{
    ...
    public function post($data, $validator, $helper): JsonResponse
    {
        ...
        $entity = $helper->setParametersToEntity(new PreguntaEvaluacion360(), $data);
    ...
    public function put($data, $id, $validator, $helper): JsonResponse
    {
        ...
        $entityManager = $this->getEntityManager();
        $entity = $entityManager->getRepository(PreguntaEvaluacion360::class)->find($id);
        if (!$entity) {
    ...
    {
        $entityManager = $this->getEntityManager();
        $entityPregunta = $entityManager->getRepository(PreguntaEvaluacion360::class)->find($id);
        if (!$entityPregunta) {
            return new JsonResponse(['msg' => 'No existen Registros con el id: ' . $id], 404);
        }
