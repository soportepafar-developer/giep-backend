...
/**
 * @method HistArchivoContVersiond|null find($id, $lockMode = null, $lockVersion = null)
 * @method HistArchivoContVersiond|null findOneBy(array $criteria, array $orderBy = null)
 * @method HistArchivoContVersiond[]    findAll()
 * @method HistArchivoContVersiond[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class HistArchivoContVersiondRepository extends ServiceEntityRepository
{
    ...
    public function __construct(ManagerRegistry $registry,Security $security)
    {
        ...
        parent::__construct($registry, HistArchivoContVersiond::class);
    }
        ...
        public function getBuscarHistoricoArchivosById($id,$dirserv){
            ...
            foreach($paginator as $clave=>$valor){
                ...
                $currentOperaciones =$entityManager->getRepository(TipoOperacionesd::class)->find(2);
                ...
                $currentArchivos =$entityManager->getRepository(Archivosd::class)->find($valor->getIdarchivo());
                if (!$currentArchivos) {
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?HistArchivoContVersiond
    {
        return $this->createQueryBuilder('h')
            ->andWhere('h.exampleField = :val')
            ->setParameter('val', $value)
