...
/**
 * @method TipoInputEvaluacion|null find($id, $lockMode = null, $lockVersion = null)
 * @method TipoInputEvaluacion|null findOneBy(array $criteria, array $orderBy = null)
 * @method TipoInputEvaluacion[]    findAll()
 * @method TipoInputEvaluacion[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TipoInputEvaluacionRepository extends ServiceEntityRepository
{
    private $security;
    public function __construct(ManagerRegistry $registry,Security $security)
    {
        $this->security = $security;
        parent::__construct($registry, TipoInputEvaluacion::class);
    }
    ...
    public function findAllPage($data){
        ...
        foreach($paginator as $clave=>$valor){
            $tipoinputDto =new TipoInputEvaluacionDto();
    ...
    public function post($data,$validator,$helper): JsonResponse  {
        ...
        $entity=$helper->setParametersToEntity(new TipoInputEvaluacion(),$data);
    ...
    {
        $entityManager = $this->getEntityManager();
        $entity =$entityManager->getRepository(TipoInputEvaluacion::class)->find($id);
        if (!$entity) {
            return new JsonResponse(['msg'=>'No existen Registros con el id: '.$id],404);  
        }
