...
use App\Repository\Instrumento360\OpcionesEvaluacion360Repository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=OpcionesEvaluacion360Repository::class)
 */
class OpcionesEvaluacion360
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=PreguntaEvaluacion360::class, inversedBy="opciones")
     */
    private $idPregunta;
    ...
    /**
     * @ORM\OneToMany(targetEntity=RespuestaEvaluacion360::class, mappedBy="idOpcion")
     */
    private $respuestas;
    ...
    /**
     * @return Collection|RespuestaEvaluacion360[]
     */
