...
use App\Repository\Instrumento360\TipoInputEvaluacion360Repository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=TipoInputEvaluacion360Repository::class)
 */
class TipoInputEvaluacion360
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToMany(targetEntity=PreguntaEvaluacion360::class, mappedBy="idInput")
     */
    private $preguntas;
