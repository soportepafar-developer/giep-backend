...
class Pregunta
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=TipoCategoria::class, inversedBy="preguntas")
     */
    private $IdCategoria;

    /**
     * @ORM\ManyToOne(targetEntity=InstrumentoCaptura::class, inversedBy="preguntas",cascade={"persist"} )
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity=Opciones::class, mappedBy="idPregunta", orphanRemoval=true)
     */
    private $opciones;

    /**
     * @ORM\OneToMany(targetEntity=Respuesta::class, mappedBy="idPregunta", orphanRemoval=true)
     */
    private $respuestas;

    /**
     * @ORM\ManyToOne(targetEntity=Seccion::class, inversedBy="preguntas")
     */
    private $seccion;

    /**
     * @ORM\ManyToOne(targetEntity=Empresa::class, inversedBy="preguntas")
     */
    private $idempresa;
    ...
    */
    ...
    public function getIdCategoria(): ?TipoCategoria
    {
        return $this->IdCategoria;
    }

    public function setIdCategoria(?TipoCategoria $IdCategoria): self
    {
    ...
    public function addOpcione(Opciones $opcione): self
    {
    ...
    public function removeOpcione(Opciones $opcione): self
    {
