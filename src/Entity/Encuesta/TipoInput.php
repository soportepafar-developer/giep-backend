...
/**
 * @ORM\Entity(repositoryClass=TipoInputRepository::class)
 */
class TipoInput
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Pregunta::class, mappedBy="idInput")
     */
    private $preguntas;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Empresa::class, inversedBy="idtipoinput")
     */
    private $idempresa;
