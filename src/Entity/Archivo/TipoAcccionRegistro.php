...
use App\Repository\Archivo\TipoAcccionRegistroRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=TipoAcccionRegistroRepository::class)
 */
class TipoAcccionRegistro
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToMany(targetEntity=Archivos::class, mappedBy="id_accion_registro")
     */
    private $idaccion_registro_archivo;

    /**
     * @ORM\OneToMany(targetEntity=HistArchivoContVersion::class, mappedBy="idaccionregistro")
     */
    private $idaccionregistro_hist;

    /**
     * @ORM\ManyToOne(targetEntity=Empresa::class, inversedBy="idtipoaccionregistro")
     */
    private $idempresa;
    ...
    public function addIdaccionregistroHist(HistArchivoContVersion $idaccionregistroHist): self
    {
    ...
    public function removeIdaccionregistroHist(HistArchivoContVersion $idaccionregistroHist): self
    {
