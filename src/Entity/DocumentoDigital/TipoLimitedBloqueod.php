...
use App\Repository\DocumentoDigital\TipoLimitedBloqueodRepository;
...
/**
 * @ORM\Entity(repositoryClass=TipoLimitedBloqueodRepository::class)
 */
class TipoLimitedBloqueod
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToMany(targetEntity=Archivosd::class, mappedBy="id_limited_bloqueo")
     */
    ...
    public function addIdarchivolimitedbloqueo(Archivosd $idarchivolimitedbloqueo): self
    {
    ...
    public function removeIdarchivolimitedbloqueo(Archivosd $idarchivolimitedbloqueo): self
    {
