...
use App\Repository\DocumentoDigital\TipoEstadodRepository;
...
/**
 * @ORM\Entity(repositoryClass=TipoEstadodRepository::class)
 */
class TipoEstadod
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Archivosd::class, mappedBy="idestado")
     */
    ...
    public function addIdestadoarchivo(Archivosd $idestadoarchivo): self
    {
    ...
    public function removeIdestadoarchivo(Archivosd $idestadoarchivo): self
    {
