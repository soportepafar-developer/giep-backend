...
/**
 * @ORM\Entity(repositoryClass=RespuestaEvaluacionRepository::class)
 */
class RespuestaEvaluacion
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=PreguntaEvaluacion::class, inversedBy="respuestas")
     * @ORM\JoinColumn(nullable=false)
     */
    private $idPregunta;

    /**
     * @ORM\ManyToOne(targetEntity=OpcionesEvaluacion::class, inversedBy="respuestas")
     */
    private $idOpcion;
    ...
    public function getIdOpcion(): ?OpcionesEvaluacion
    {
        return $this->idOpcion;
    }

    public function setIdOpcion(?OpcionesEvaluacion $idOpcion): self
    {
