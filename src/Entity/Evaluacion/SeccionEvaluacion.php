...
use App\Repository\Evaluacion\SeccionEvaluacionRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=SeccionEvaluacionRepository::class)
 */
class SeccionEvaluacion
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Evaluacion::class, inversedBy="seccions")
     * @ORM\JoinColumn(nullable=false)
     */
    private $evaluacion;

    /**
     * @ORM\OneToMany(targetEntity=PreguntaEvaluacion::class, mappedBy="seccion", orphanRemoval=true)
     */
    private $preguntas;
