...
class Instrumento360Controller extends AbstractController
{
    ...
    */  
    ...
    /**
        * @Route("/api/instrumento360/pagined1", methods={"POST"})
        * @OA\Post(
         * summary="Instrumento Captura List AllPages",
         * description="Instrumento Captura List",
         * operationId="instrumento360pagined",
         * tags={"Instrumento360"},
         * @OA\RequestBody(
         *    required=true,
         *    description="parametro",
         ...
         * )
    */   
    public function findListByInstructor(Request $request,Instrumento360Repository $repository): JsonResponse
    {
