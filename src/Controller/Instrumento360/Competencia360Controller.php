...
class Competencia360Controller extends AbstractController
{
    ...
    */
    ...
    /**
        * @Route("/api/instrumento360/list", methods={"POST"})
        * @OA\Post(
         * summary="Instrumento List AllPages",
         * description="Instrumento List",
         * operationId="instrumentolist",
         * tags={"Instrumento 360"},
         * @OA\RequestBody(
         *    required=true,
         *    description="parametro",
         ...
         * )
    */   
    public function findInstrumentoList(Request $request,Competencia360Repository $repository ): JsonResponse
    {
        $param = json_decode($request->getContent(),true);
        $data = $repository
        ->findAllPage($param);
