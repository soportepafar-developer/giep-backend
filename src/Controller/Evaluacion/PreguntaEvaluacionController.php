...
use App\Form\Evaluacion\PreguntaType;
use App\Repository\Evaluacion\PreguntaRepository;
...
class PreguntaEvaluacionController extends AbstractController
{

        /**
        * @Route("/api/evaluacion/pregunta/pagined", methods={"POST"})
        * @OA\Post(
         * summary="Preguntas Evaluacion Pagined",
         * description="Preguntas Evaluacion Pagined",
         * operationId="preguntalistevaluacion",
         * tags={"Preguntas Evaluacion"},
         * @OA\RequestBody(
         *    required=true,
    ...
    */   
    public function findList(Request $request,PreguntaRepository $preguntaRepository): JsonResponse
    {
      ...
      /**
        * @Route("/api/evaluacion/pregunta", methods={"POST"})
        * @OA\Post(
         * summary="Create Pregunta",
         * description="Create Pregunta",
         * operationId="createPreguntaevaluacion",
         * tags={"Preguntas Evaluacion"},
         * @OA\RequestBody(
         *    required=true,
    ...
    */
    ...
    {   
        ...
        /**
        * @Route("/api/evaluacion/pregunta/actualizar/{id}", methods={"PUT"})
        * @OA\Put(
         * summary="Put Preguntas Evaluacion",
         * description="Update Preguntas Evaluacion",
         * operationId="updatePreguntasevaluacion",
         * tags={"Preguntas Evaluacion"},
         * @OA\RequestBody(
         *    required=true,
         *    description="Data Preguntas Evaluacion",
         *    @OA\JsonContent(
         *       required={"nombre","descripcion"},
         *       @OA\Property(property="pregunta", type="string", example="Posee licencia de conducir"),
         *       @OA\Property(property="orden", type="string", example="1"),
    ...
    */
    ...
    /**
     *  Get an Pregunta. 
     * @Route("/api/evaluacion/pregunta/{id}", methods={"GET"})
     * @OA\Response(
     *     response=200,
     *     description="Returns Pregunta",
     *     @OA\JsonContent(
     *        type="array",
     *        @OA\Items(ref=@Model(type=App\Dto\Evaluacion\PreguntaEvaluacionDto::class))
     *     )
     * )
     * @OA\Tag(name="Preguntas Evaluacion")
    ...
    /**
        * @Route("/api/evaluacion/pregunta/{id}", methods={"DELETE"})
        * @OA\Delete(
         * summary="Delete Preguntas Evaluacion",
         * description="Delete Preguntas Evaluacion",
         * operationId="deletepreguntaevaluacion",
         * tags={"Preguntas Evaluacion"},
         * @OA\Response(
         *    response=422,
         *    description="Wrong credentials response",
    ...
    */
    public function delete($id,ValidatorInterface $validator,Helper $helper): JsonResponse
    {
        try {
            $em =$this->getDoctrine()->getManager();
            $repository = $this->getDoctrine()->getRepository(PreguntaEvaluacion::class);
