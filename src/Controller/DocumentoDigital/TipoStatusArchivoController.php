...
class TipoStatusArchivoController extends AbstractController
{
    /**
     *  Get list archivodigitalstatus. 
     * @Route("/api/archivodigitalstatus/list", methods={"GET"})
     * @OA\Response(
     *     response=200,
     *     description="Returns Status",
     *     @OA\JsonContent(
     *        type="array",
     *        @OA\Items(ref=@Model(type=TipoStatusArchivoOutPutDto::class))
     *     )
     * )
     * @OA\Tag(name="Archivos Digital")
     * @Security(name="Bearer")
     */
    public function findList(Request $request,TipoStatusArchivodRepository $repository): JsonResponse
    {
