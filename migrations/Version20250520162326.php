 ...
 */
final class Version20250520162326 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pregunta_evaluacion360 (id INT AUTO_INCREMENT NOT NULL, id_instrumento_id INT DEFAULT NULL, id_input_id INT DEFAULT NULL, seccion_id INT DEFAULT NULL, idempresa_id INT DEFAULT NULL, pregunta VARCHAR(1000) NOT NULL, orden SMALLINT DEFAULT NULL, class VARCHAR(255) DEFAULT NULL, obligatorio SMALLINT NOT NULL, puntos VARCHAR(255) DEFAULT NULL, create_at DATETIME DEFAULT NULL, create_by VARCHAR(255) DEFAULT NULL, update_at DATETIME DEFAULT NULL, update_by VARCHAR(255) DEFAULT NULL, INDEX IDX_CCED1017396DC676 (id_instrumento_id), INDEX IDX_CCED10176699F643 (id_input_id), INDEX IDX_CCED10177A5A413A (seccion_id), INDEX IDX_CCED10179FB704AB (idempresa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pregunta_evaluacion360 ADD CONSTRAINT FK_CCED1017396DC676 FOREIGN KEY (id_instrumento_id) REFERENCES competencia360 (id)');
